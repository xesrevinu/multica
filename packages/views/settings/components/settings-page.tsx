...
export function SettingsPage({ extraAccountTabs }: SettingsPageProps = {}) {
  ...
  return (
    ...
    >
      ...
      <div className="min-w-0 max-w-full shrink-0 overflow-x-auto border-b border-surface-border p-2 md:w-56 md:max-w-none md:overflow-y-auto md:border-b-0 md:border-r md:p-4">
